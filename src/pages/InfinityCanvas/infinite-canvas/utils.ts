...
export function getChunkUpdateThrottleMs(isZooming: boolean, zoomSpeed: number): number {
  if (zoomSpeed > 1.0) {
    return 500
  }
...
export function getMediaDimensions(media: HTMLImageElement | undefined) {
...
export function generateChunkPlanes(cx: number, cy: number, cz: number): PlaneData[] {
...
export function shouldThrottleUpdate(lastUpdateTime: number, throttleMs: number, currentTime: number): boolean {
