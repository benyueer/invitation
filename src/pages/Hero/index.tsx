...
const Hero: React.FC<HeroProps> = ({ isDarkMode = false }) => {
  ...
  const imageUrls = randomPick('webp', 'high', 10)

  // Helper: Populate images in a segment
  // Defined before use to fix lint error
  ...
  useEffect(() => {
    ...
    const onTouchMove = (e: TouchEvent) => {
      ...
      touchStartY = e.touches[0].clientY
      scrollPosRef.current -= deltaY * 2 // Amplify touch scroll
