...
const CRITICAL_IMAGES = [
  ...
  "/pics/wel_c.png",
  "/pics/invi.png",
  "/images_high/v/theme1/IMG_1536.webp",
  "/images_high/v/theme1/IMG_1530.webp",
];
...
export default function Home() {
  ...
  const { loading, progress } = useImagePreloader(CRITICAL_IMAGES);
  ...
  return (
    <>
      ...
      <div
        className={`w-full h-100vh overflow-auto transition-opacity duration-1000 ${loading ? "opacity-0" : "opacity-100"}`}
      >
        <div
          className="w-full h-100vh bg-[url('/pics/main_bg.webp')] bg-repeat relative overflow-hidden"
        ...
        <div
          className="w-full bg-[url('/pics/main_bg.webp')] bg-repeat relative overflow-hidden py-10"
          style={{ backgroundSize: "110%", backgroundPosition: "-10px 0" }}
        >
          <div
          ...
          <div className="w-80vw mx-auto mt-10 mb-20">
            ...
            >
              ...
              <p>是官方宣告也是真挚邀请</p>
              <p>诚邀您携家人见证我们的幸福时刻</p>
              <div className="px-4 py-2 my-2 rounded-2xl bg-amber">
                婚礼时间
              </div>
              <p>2026年2月13日</p>
              <p>农历腊月二十六（星期五）</p>
        ...
        <div
          className="w-full bg-[url('/pics/main_bg.webp')] bg-repeat relative overflow-hidden"
          style={{ backgroundSize: "110%", backgroundPosition: "-10px 0" }}
        >
        ...
        <Modal
          title={
            <div className="text-center w-full text-xl py-2">联系我们</div>
          }
